...
public class Scenario {
	...
	public static void main(String[] args) throws InterruptedException {
    	...
    	Thread.sleep(4000);
    	WebElement frame = driver.findElement(By.xpath("//li[@class='active']/a[contains(text(),'Diamond')]"));
    	driver.switchTo().frame(frame);
    	driver.findElement(By.xpath("//li[@class='active']/a[contains(text(),'Diamond')]"));
